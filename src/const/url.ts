...
export const DISCORD = 'https://invenire.com.tr';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'www.invenire.com.tr/discussions/1284';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'www.invenire.com.tr/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/aliozkanozdurmus/invenire-law-expert';
...
export const EMAIL_SUPPORT = 'support@invenire.com.tr';
export const EMAIL_BUSINESS = 'info@invenire.com.tr';

export const MEDIDUM = 'https://aliozkanozdurmus.medium.com';
export const X = 'https://invenire.com.tr';
export const RELEASES_URL = urlJoin(GITHUB, 'releases');

export const mailTo = (email: string) => `mailto:${email}`;

export const AES_GCM_URL = 'https://datatracker.ietf.org/doc/html/draft-ietf-avt-srtp-aes-gcm-01';
export const BASE_PROVIDER_DOC_URL = 'https://invenire.com.tr';
